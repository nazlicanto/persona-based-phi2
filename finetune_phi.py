...
def finetune_model(args):
    ...
    #format_instruction(dataset["train"][0])
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--base_model", type=str, default="agents/phi2_model/microsoft--phi-2", 
        help="HF hub id of the base model to finetune."
    )
    parser.add_argument(
        "--model_name", type=str, default="nazlicanto/phi-2-persona-chat", help="Name of finetuned model."
    )
    parser.add_argument(
